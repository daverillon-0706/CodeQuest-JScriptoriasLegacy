const quizData = {
  ...
  datatypes: [
    ...
    { type: "compiler", question: "Create a variable with a string 'JavaScript'", starterCode: `// Your code here`, expectedOutput: "JavaScript" }
  ],
  ...
  variables: [
    ...
    { type: "compiler", question: "Declare a let variable called 'score' and assign 100", starterCode: `// Your code here`, expectedOutput: "100" }
  ],
  ...
  operators: [
    ...
    { type: "compiler", question: "Write an expression that adds 5 + 7", starterCode: `// Your code here`, expectedOutput: "12" }
  ],
  ...
  arrays: [
    ...
    { type: "compiler", question: "Create an array with numbers 1, 2, 3", starterCode: `// Your code here`, expectedOutput: "[1,2,3]" }
  ],
  ...
  functions: [
    ...
    { type: "compiler", question: "Fix the function to return 10", starterCode: `function add() { return 5 + 5 }`, expectedOutput: "10" }
  ]
};
