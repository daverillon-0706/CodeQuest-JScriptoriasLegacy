...
<tileset version="1.10" tiledversion="1.11.2" name="borderwall" tilewidth="16" tileheight="16" tilecount="9" columns="9">
 <image source="borderwall.png" width="144" height="16"/>
 <tile id="0">
  <animation>
